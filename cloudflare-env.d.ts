/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: fbc3047d3e3b0fffd4d5af7f6faa3c16)
// Runtime types generated with workerd@1.20251011.0 2025-03-01 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		NEXT_PUBLIC_MEMBERSTACK_PUBLIC_KEY: string;
